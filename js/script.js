...
const STRATEGIES_SOCIAL = [
    {
        ...
        description: 'Actividades para generar empatía y eliminar prejuicios sociales hacia la diversidad.',
        examples: [
    ...
    },
    {
        ...
        description: 'Impulsar la colaboración de familias en actividades escolares inclusivas.',
        examples: [
    ...
    },
    {
        ...
        description: 'Normas claras y procedimientos para prevenir la discriminación.',
        examples: [
    ...
    },
    {
        ...
        description: 'Promover la participación activa de estudiantes diversos en roles de liderazgo.',
        examples: [
    ...
    },
    {
        ...
        description: 'Actividades que fomentan el respeto entre culturas y tradiciones diversas.',
        examples: [
...
const STRATEGIES_PEDAGOGICAS = [
    {
        ...
        description: 'Aplicar principios del DUA con múltiples formas de representación, participación y compromiso.',
        examples: [
    ...
    },
    {
        ...
        description: 'Formar al personal en competencias inclusivas y uso de tecnología asistiva.',
        examples: [
    ...
    },
    {
        ...
        description: 'Ampliar recursos educativos con materiales tangibles y accesibles.',
        examples: [
    ...
    },
    {
        ...
        description: 'Crear equipos de apoyo con profesionales que acompañen al estudiante.',
        examples: [
            'Psicólogo educativo',
...
let QUIZ_DATA = [
    {
        ...
        options: [
            { img: "img/imagen1.jpg", alt: "Niño en silla de ruedas frente a una escalera sin rampa" },
            { img: "img/imagen2.jpg", alt: "Niño en silla de ruedas usando una rampa con ayuda de compañeros" },
            { img: "img/imagen3.webp", alt: "Un aula sin adaptaciones especiales" },
            { img: "img/imagen4.jpg", alt: "Niños jugando sin incluir a un compañero con discapacidad" }
        ],
        correct: 1,
        explanation: "La inclusión se representa cuando el niño puede usar la rampa y recibe apoyo positivo."
    },
    {
        question: "¿Qué imagen muestra apoyo entre compañeros?",
        options: [
            { img: "img/imagen5.jpg", alt: "Niño solo con dificultad" },
            { img: "img/imagen6.webp", alt: "Niños ayudando a un compañero con discapacidad" },
            { img: "img/imagen7.jpg", alt: "Profesor explicando solo a un estudiante" },
            { img: "img/imagen8.jpg", alt: "Grupo de niños trabajando juntos pero excluyendo a uno" }
        ],
        correct: 1,
        explanation: "La imagen correcta es cuando los amigos apoyan al compañero para que participe con todos."
    },
    {
        question: "¿Cuál de estas situaciones es inclusiva?",
        options: [
            { img: "img/imagen9.webp", alt: "Niños jugando y un compañero excluido" },
            { img: "img/imagen10.jpg", alt: "Niños jugando todos juntos con un compañero con discapacidad" },
            { img: "img/imagen11.jpg", alt: "Aula con mesas sin adaptaciones" },
            { img: "img/imagen12.webp", alt: "Patio escolar sin rampas" }
        ],
        correct: 1,
        explanation: "La inclusión se da cuando todos los niños participan juntos en el juego."
    },
    {
        question: "¿Qué imagen muestra un aula inclusiva?",
        options: [
            { img: "img/imagen13.jpg", alt: "Aula con mesas sin adaptaciones" },
            { img: "img/imagen14.jpg", alt: "Aula con rampas, señalización y materiales adaptados" },
            { img: "img/imagen15.webp", alt: "Aula espaciosa pero sin adaptaciones" },
            { img: "img/imagen16.jfif", alt: "Biblioteca con pocos libros accesibles" }
        ],
        correct: 1,
        explanation: "Un aula inclusiva tiene adaptaciones y materiales que permiten aprender a todos los estudiantes."
    },
    {
        question: "¿Dónde se ve la colaboración inclusiva?",
        options: [
            { img: "img/imagen17.jpg", alt: "Un grupo ignora a un compañero" },
            { img: "img/imagen18.webp", alt: "Un grupo ayuda a un compañero a integrarse" },
            { img: "img/imagen19.png", alt: "Un grupo reunido sin participación de todos" },
            { img: "img/imagen20.webp", alt: "Estudiantes en un debate sin dar turno a un compañero" }
        ],
        correct: 1,
        explanation: "La colaboración inclusiva es cuando todos apoyan a los compañeros para participar."
    }
];
...
function loadStrategies() {
    ...
    renderSection('Barrera de Infraestructura Física', STRATEGIES_INFRAESTRUCTURA);
...
function displayQuizQuestion() {
    ...
    container.innerHTML = `
        <div class="question-card readable">
            <div class="question-text"><strong>Pregunta ${currentQuizQuestion + 1}</strong><br>${question.question}</div>
    ...
    question.correctIndex = shuffledOptions.findIndex(opt => opt === question.options[question.correct]);
...
function checkAnswer() {
    ...
    options.forEach((btn, index) => {
        ...
        else if (index === selectedAnswer && !isCorrect) btn.classList.add('incorrect');
    });
...
function showQuizResults() {
    ...
    let resultMessage = percentage >= 80 ? '¡Excelente dominio del tema!' :
